...
C:\Robocopy\Tools\Robocopy  %SrcDrv%:\MP3   %DstDrv%:\CashMedia\MP3 /E /Purge /XA:ST /ZB /R:0 /W:5  /LOG:C:\Robocopy\BackupCashMedia.log /TEE /NDL /NP /NS /COPY:DAT /PF
